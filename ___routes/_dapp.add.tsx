...
import { getNftStorageClient } from "~/utils/nft-storage.server"
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  switch (formData.get("_action")) {
    ...
    case "cid": {
      ...
      // https://nftstorage.github.io/nft.storage/client/classes/lib.NFTStorage.html#storeDirectory
      const cid = await client.storeDirectory([
        new File([JSON.stringify({ css, svg })], "metadata.json"),
      ])
